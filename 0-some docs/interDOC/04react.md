...
# QUESTION：说说 Real DOM 和 Virtual DOM 的区别？优缺点？
...
# QUESTION：说说 React 生命周期有哪些不同阶段？每个阶段对应的方法是？
...
# QUESTION：super() 和 super(props) 有什么区别？
...
# QUESTION：说说 React中的setState执行机制
    ...
    render() {
        return (
            <div>
                ...
                <button onClick={e => this.changeText()}>QUESTION系列</button>
            </div>
        )
    }
...
# QUESTION：说说对React refs 的理解？应用场景？
...
# QUESTION：说说对React中类组件和函数组件的理解？有什么区别？
...
# QUESTION：说说对受控组件和非受控组件的理解？应用场景？
...
# QUESTION：说说对React Hooks的理解？解决了什么问题？
...
# QUESTION：说说react中引入css的方式有哪几种？区别？
...
# QUESTION：说说对Redux中间件的理解？常用的中间件有哪些？实现原理？
...
# QUESTION：你在React项目中是如何使用Redux的? 项目结构是如何划分的？
...
# QUESTION：说说你对React Router的理解？常用的Router组件有哪些？
...
# QUESTION：说说React Router有几种模式？实现原理？
...
# QUESTION：说说你对immutable的理解？如何应用在react项目中？
...
# QUESTION：说说React render方法的原理？在什么时候会被触发？
...
# QUESTION：说说你是如何提高组件的渲染效率的？在React中如何避免不必要的render？
...
# QUESTION：说说对Fiber架构的理解？解决了什么问题？
...
# QUESTION：说说React Jsx转换成真实DOM过程？
...
# QUESTION：说说React服务端渲染怎么做？原理是什么？
...
# QUESTION：说说你在使用React 过程中遇到的常见问题？如何解决?
